...
<div class="login-box">
  <div class="login-logo">
      <img src="<?php echo base_url(); ?>assets/img/logos-whitebackground.png" width="140px">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form class="form" method="post" action="<?php echo site_url('Login/getDataUserByUsernamePassword'); ?>">
